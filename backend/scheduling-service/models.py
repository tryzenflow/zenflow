...
class Task:
  ...
  def __str__(self) -> str:
    return f'{self.id} - {self.title} ({self.duration} min) - earliest_start: {self.earliest_start}, latest_end: {self.latest_end}, deadline: {self.deadline}, priority: {self.priority}'
