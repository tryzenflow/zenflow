...
describe("driftedFieldFor", () => {
  ...
  it("drifts pGlobal by peakShiftBlocks × monthsElapsed", () => {
    ...
    expect(drifted.pGlobal[44]).toBe(10);
    expect(drifted.pGlobal[40]).toBe(0);
