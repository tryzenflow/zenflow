...
│       │                      # <CreateSessionFab> so task creation isn't Day-only
...
│   │   │                      # implicitly repacks that one day server-side, see "Screens &
│   │   │                      # routing" below and lib/task-toasts.ts's dayRescheduleToastMessage
...
│   │                             # dayRescheduleToastMessage for the implicit same-day repack
